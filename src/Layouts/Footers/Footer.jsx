        ...
        <footer className="bg-sky-800">
                    ...
                    <ul>
                        <li>
                            <p className="flex items-center gap-2 mb-3">
                                <MdOutlineLocationOn />
                                <span>
                                    Số 456 Minh Khai, P.Vĩnh Tuy, Q.Hai Bà
                                    Trưng, TP.Hà Nội{' '}
                                </span>
                            </p>
                        </li>
                        <li>
                            <p className="flex items-center gap-2 mb-3">
                                <MdOutlineLocationOn />
                                <span>
                                    Số 218 Đường Lĩnh Nam, Q.Hoàng Mai, TP.Hà
                                    Nội{' '}
                                </span>
                            </p>
                        </li>
                    ...
                    <ul>
                        <li>
                            <p className="flex items-center gap-2 mb-3">
                                <MdOutlineLocationOn />
                                <span>
                                    Số 353 Trần Hưng Đạo, P.Bà Triệu, TP.Nam
                                    Định
                                </span>
                            </p>
                        </li>
                        <li>
                            <p className="flex items-center gap-2 mb-3">
                                <MdOutlineLocationOn />
                                <span>
                                    Khu xưởng Thực hành: Phường Mỹ Xá, TP.Nam
                                    Định
                                </span>
                            </p>
                        </li>
            ...
            <div className="bg-[#134156]">
                <div className="max-w-7xl mx-auto text-white flex items-center justify-between font-semibold p-3">
                    <p>
                        &#169; Copyright Trường Đại học Kinh tế - Kỹ thuật Công
                        nghiệp
                    </p>
