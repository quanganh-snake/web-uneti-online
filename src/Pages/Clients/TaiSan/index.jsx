    ...
    <main className="my-[120px]">
      ...
      <section className="flex flex-col lg:flex-row gap-4 items-stretch px-2 mb-4">
        <div className="uneti-qlsp__thongke w-full flex-grow-0 lg:flex-grow-2">
          <div className="bg-sky-900 px-2 rounded-lg h-[100%]">
        ...
        <div className="uneti-qlsp__canbohotro flex-grow">
          <div className="canbohotro-box border lg:w-[300px] rounded-lg">
            <h6 className="text-white font-semibold rounded-t-lg text-center py-2 bg-[#336699]">
              ...
              <div className="canbohotro--container overflow-x-hidden">
                {listCanBoHoTro &&
                  ...
                  listCanBoHoTro.map((canbo) => (
                    <div
                      className="canbohotro-item flex gap-2 items-center mb-4"
                      key={canbo.id}
                    >
                      <div className="canbohotro--chucvu h-10 w-10 bg-[#336699] text-white font-semibold rounded-full flex items-center justify-center">
                        {canbo.position}
                      </div>
                ...
                <div className="hotline--list pt-2 px-2">
                  {listHotlines &&
                    ...
                    listHotlines.map((hotline) => (
                      <div
                        className="hotline--item flex flex-row gap-4 mb-4"
                        key={hotline.id}
                      >
          ...
          <div className="list-require__action flex flex-col lg:flex-row lg:justify-between mb-4">
            <div className="action--data grid grid-cols-3 items-center gap-4 mb-4 lg:mb-0">
              ...
              <button
                ...
                className="bg-[#336699] text-white font-semibold rounded-lg px-3 py-2 hover:opacity-70  col-span-3 lg:col-span-1"
              >
                Yêu cầu hỗ trợ
              </button>
              <button
                type="button"
                className="border font-semibold rounded-lg px-3 py-2 bg-red-700 text-white hover:opacity-70 col-span-3 lg:col-span-1"
              >
                Xóa
              </button>
            </div>
            <div className="action--filter flex items-center flex-wrap gap-4">
              <div className="filter-search relative">
                <input
                  ...
                  className="p-2 pr-12 border rounded-lg focus:outline-none"
                />
              ...
              <button
                type="button"
                className="px-3 py-2 bg-sky-400 font-semibold rounded-lg hover:opacity-70"
              >
                Làm mới
              </button>
            </div>
          ...
          <div className="list-require__table">
            <div className="inline-block max-w-full py-2">
                  ...
                  <table className="w-auto border text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr className="border-b">
                        <th
                          scope="col"
                          className="whitespace-nowrap p-4 border-r w-[10px]"
                        >
                        ...
                        <th
                          scope="col"
                          className="whitespace-nowrap px-6 py-3 text-center border-r w-[240px]"
                        >
                          Mô tả sự cố
                        </th>
                        <th
                          scope="col"
                          className="whitespace-nowrap px-6 py-3 text-center border-r w-[60px]"
                        >
                          Thời gian yêu cầu
                        </th>
                        <th
                        ...
                        <th
                          scope="col"
                          className="whitespace-nowrap pt-3 text-center border-r"
                        >
                          <span>Địa chỉ</span>
                          <table className="mt-2 border border-solid w-full px-4">
                            <tbody>
                              <tr>
                                <td
                                  scope="col"
                                  className="px-6 py-3 text-center border-r whitespace-nowrap"
                                >
                                  Cơ sở
                                </td>
                                <td
                        ...
                        <th
                          scope="col"
                          className="whitespace-nowrap px-6 py-3 text-center border-r w-[100px]"
                        >
                          Kết quả xử lý
                        </th>
                        <th
                          scope="col"
                          className="whitespace-nowrap px-4 py-3 text-center border-r w-[60px]"
                        >
                          Người xử lý sự cố
                        </th>
                        <th
                          scope="col"
                          className="whitespace-nowrap px-6 py-3 text-center w-[60px]"
                        >
                          Ngày hoàn thành
                        </th>
                      </tr>
                          ...
                          >
                            <td className="w-4 p-4 border-r">
                              <div className="flex items-center">
                                <input
                                  ...
                                  onChange={() =>
                                    handleRowClick(yeucau.DT_QLTS_TS_ID)
                                  }
                                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                />
                                <label
                            ...
                            <td className="whitespace-nowrap py-1 border-r">
                              <table className="border border-solid w-full px-4">
                                <tbody>
                                  <tr>
                                    <td className="whitespace-nowrap px-6 py-4 border-r font-semibold">
                                      Cơ sở
                                    </td>
                                    <td className="whitespace-nowrap px-6 py-4 border-r font-semibold">
                                      Địa điểm
              ...
              <ReactPaginate
                ...
                previousLabel={
                  <AiFillCaretLeft className="text-2xl text-sky-800" />
                }
                nextLabel={
                  <AiFillCaretRight className="text-2xl text-sky-800" />
                }
                pageCount={
                  listYeuCauSuCo
                    ? Math.ceil(listYeuCauSuCo.length / ITEMS_PER_PAGE)
                    : 0
                }
