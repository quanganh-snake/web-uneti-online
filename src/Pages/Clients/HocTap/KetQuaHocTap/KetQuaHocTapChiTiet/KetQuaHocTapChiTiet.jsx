        ...
        getAllMonHoc(dataSV.MaSinhVien).then((res) => {
            if (
                !res?.data?.body.filter(
                    (mh) =>
                        mh.TC_SV_KetQuaHocTap_MaLopHocPhan.toString() === id,
                ).length
            ) {
        ...
        <div>
            ...
            <div className="bg-white mt-4 p-10 rounded-md shadow-sm">
                <h3 className="uppercase w-full text-center font-bold text-xl mb-4 text-uneti-primary">
                    ...
                    {monHoc.TC_SV_KetQuaHocTap_TenMonHoc}
                </h3>
                <div>
                                ...
                                <tbody className="font-[500]">
                                    <tr>
                                        ...
                                        <td className="p-2 border border-solid border-uneti-primary border-opacity-30 text-center border-b-0 border-r-0">
                                            {monHoc.TC_SV_KetQuaHocTap_VangThi
                                                ? 'Vắng thi'
                                                : ''}
                                        </td>
                                    </tr>
                ...
                <div>
                    <p className="mb-2 font-semibold italic">
                        Lưu ý: Quy định đánh giá kết quả học tập theo quy chế
                        hiện hành
                    </p>
                    <p className="mb-2">
                        ...
                        Có hệ số bằng số tín chỉ của học phần và được đánh giá
                        theo thời gian học tập trên lớp
                    </p>
                    <p className="mb-2 font-semibold italic">
                        - Điểm thường kỳ:
                    </p>
                    <p className="mb-2 ml-4">
                        + Điểm thường kỳ/Điểm hệ số 1: Có hệ số là 1 (Số lượng
                        đầu điểm hệ số 1 được nhập điểm tùy theo từng học phần)
                    </p>
                    <p className="mb-2 ml-4">
                        + Điểm thường kỳ/Điểm hệ số 2: Có hệ số là 2 (Số lượng
                        đầu điểm hệ số 2 được nhập điểm tùy theo từng học phần)
                    </p>
                    <p className="mb-2 font-semibold italic">
                        - Điểm thi kỹ năng (KN):
                    </p>
                    <p className="mb-2 ml-4">
                        + Được thiết kế bao gồm 4 đầu điểm thi của các kỹ năng
                        nghe, nói, đọc, viết của các học phần: Tiếng Anh 1;
                        Tiếng Anh 2; Tiếng Anh 3; Tiếng Anh 4; Tiếng Anh 5. Tuy
                        nhiên hiện tại nhà trường đang áp dụng đánh giá 2 kỹ
                        năng: Nghe; Đọc.
                    </p>
                    <p className="mb-2 ml-4">
                        + Nếu học phần có điểm thi KN thì không có điểm thi kết
                        thúc học phần.
                    </p>
                    <p className="mb-2 font-semibold italic">
                    ...
                    <p className="mb-2 ml-4">
                        + Điểm thi: là điểm thi cao nhất của lần thi 1 hoặc lần
                        thi 2.
                    </p>
                    <p className="mb-2 ml-4">
                    ...
                    <p className="mb-2 ml-4">
                        + Điểm thi lần 2 (thi lại): Kết quả bài thi của lần thi
                        lại.
                    </p>
                </div>
            </div>
