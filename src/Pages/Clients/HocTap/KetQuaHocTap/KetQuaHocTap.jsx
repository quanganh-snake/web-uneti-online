                                      ...
                                      <table className="text-vs-text text-sm rounded-3xl">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  >
                                                      Điểm trung bình học kỳ hệ
                                                      10:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              (dtb) =>
                                                                  dtb.TC_SV_KetQuaHocTap_TenDot ===
                                                                  hk,
                                                          )[0]
                                                              ?.TC_SV_KetQuaHocTap_DiemTrungBinhHocKy
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={2}
                                                  ...
                                                  >
                                                      ...
                                                      4:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_DiemTrungBinhHocKy_He4
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={12}
                                                  ...
                                                  >
                                                      Điểm trung bình tích lũy:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_DiemTrungBinhTichLuy
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={2}
                                                  ...
                                                  >
                                                      ...
                                                      (hệ 4):{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_DiemTrungBinhTichLuy_He4
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={12}
                                                  ...
                                                  >
                                                      ...
                                                      ký:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_TongTinChi_DangKy
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={2}
                                                  ...
                                                  >
                                                      Tổng số tín chỉ tích lũy:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_TongTinChi_TichLuy
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={12}
                                                  ...
                                                  >
                                                      ...
                                                      đến hiện tại:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_TongTinChi_No
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={2}
                                                  ...
                                                  >
                                                      Xếp loại học lực tích lũy:{' '}
                                                      {
                                                          listDiemTrungBinh.filter(
                                                              ...
                                                              ?.TC_SV_KetQuaHocTap_XepLoaiHocLuc_TichLuy
                                                      }
                                                  </td>
                                                  <td
                                                      colSpan={12}
