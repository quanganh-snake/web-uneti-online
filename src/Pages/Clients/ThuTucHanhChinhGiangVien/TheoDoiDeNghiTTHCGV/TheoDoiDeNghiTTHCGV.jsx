...
import { delThuTucHanhChinhGuiYeuCauByID, getListThuTucYeuCauByMaNhanSu } from "../../../../Apis/ThuTucHanhChinhGiangVien/apiThuTucHanhChinhGiangVien";
...
function TheoDoiDeNghiTTHCGV() {
	...
	return (
		<div clsx={"bg-white w-full"}>
			{listHoSoYeuCau?.length < 1 && <p className="p-2 text-center text-[#336699] border font-semibold">Bạn chưa có yêu cầu đề nghị nào!</p>}
			{listHoSoYeuCau?.length > 0 && (
				<div className="w-full">
					<h3 className="uppercase font-semibold text-3xl text-center text-[#336699] mb-4">Danh sách hồ sơ đã gửi</h3>
					<div className="w-full">
									...
									return (
										<tr className="border-b hover:bg-slate-300" key={index}>
											...
											<td className="border-r text-center">
												<p>{moment(iHoSo?.MC_TTHC_GV_GuiYeuCau_NgayGui).format("DD/MM/YYYY")}</p>
											</td>
											<td className="border-r text-center">
