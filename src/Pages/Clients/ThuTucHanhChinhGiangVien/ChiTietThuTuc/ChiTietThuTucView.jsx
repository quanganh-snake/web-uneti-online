...
function ChiTietThuTucView({ home, breadcrumbs, loading, dataThuTuc }) {
	...
	for (let i = 0; i < dataThuTuc?.TrinhTuThucHien.length; i++) {
		totalTime = totalTime + parseFloat(dataThuTuc?.TrinhTuThucHien[i]?.MC_TTHC_GV_TrinhTuThucHien_ThoiGianNgay);
	}
							...
							<table className="w-full">
								<tbody>
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_LinhVuc}</td>
									</tr>
									<tr>
										<td className="px-4 py-1 border border-slate-500 font-semibold">Mã thủ tục</td>
										<td className="px-4 py-1 border border-slate-500">{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_MaThuTuc}</td>
									</tr>
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											<div className="uppercase font-semibold text-[#0C4A6E]">{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_TenThuTuc}</div>
										</td>
									</tr>
									<tr>
										<td className="px-4 py-1 border border-slate-500 font-semibold">Thủ tục liên thông</td>
										<td className="px-4 py-1 border border-slate-500">
											<input type="checkbox" defaultChecked={dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_ThuTucLienThong} disabled name="" id="" />
										</td>
									</tr>
									<tr>
										<td className="px-4 py-1 border border-slate-500 font-semibold">Thủ tục không áp dụng Một cửa</td>
										<td className="px-4 py-1 border border-slate-500">
											<input type="checkbox" defaultChecked={dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_ThuTucKhongApDungMC} disabled name="" id="" />
										</td>
									</tr>
									<tr>
										<td className="px-4 py-1 border border-slate-500 font-semibold">Thành phần hồ sơ đề nghị</td>
										<td className="px-4 py-1 border border-slate-500">
											{dataThuTuc?.ThanhPhanHoSo && dataThuTuc?.ThanhPhanHoSo.length > 0 ? (
												<table className="table-auto w-full">
													...
													<tbody>
														{dataThuTuc?.ThanhPhanHoSo?.map((iThanhPhanHoSo, index) => {
															return (
																<tr key={index}>
																				...
																				<li>
																					{iThanhPhanHoSo?.MC_TTHC_GV_ThanhPhanHoSo_TenFile ? (
																						<p>
																							...
																							<p
																								onClick={() => {
																									const base64StringWithoutPrefix = convertBufferToBase64(
																										iThanhPhanHoSo?.MC_TTHC_GV_ThanhPhanHoSo_DataFile?.data
																									);
									...
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											<p>{dataThuTuc?.ThanhPhanHoSo?.length > 0 ? dataThuTuc?.ThanhPhanHoSo?.length + " bộ" : "0"}</p>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											{dataThuTuc?.TrinhTuThucHien && dataThuTuc?.TrinhTuThucHien.length > 0 ? (
												<table className="table-auto w-full">
													...
													<tbody>
														{dataThuTuc?.TrinhTuThucHien?.map((iTrinhTu, index) => {
															return (
																<tr key={index}>
																	<td className="border border-slate-300 text-center">{index + 1}</td>
																	<td className="border border-slate-300">
									...
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											<div>
												<p>{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_DoiTuongThucHien}</p>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											<div>
												<p>{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_CanCuPhapLyCuaTTHC}</p>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											<div>{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_DieuKienThucHien}</div>
										</td>
									</tr>
									<tr>
										...
										<td className="px-4 py-1 border border-slate-500">
											<div>
												<p
													...
													onClick={() => {
														const base64StringWithoutPrefix = convertBufferToBase64(dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_TepThuTuc_DataFileFile?.data);
														handlePreviewFileBase64(dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_TepThuTuc_TenFile, base64StringWithoutPrefix);
													}}
												>
													{dataThuTuc?.ThongTinHoSo?.MC_TTHC_GV_TepThuTuc_TenFile}
												</p>
											</div>
										</td>
									</tr>
