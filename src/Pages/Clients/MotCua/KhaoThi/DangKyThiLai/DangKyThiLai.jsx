...
function DangKyThiLai() {
    ...
    useEffect(() => {
        ...
        if (hocKy !== '') {
            setLoading(true)
            getAllHocPhanDKThiLai(dataSV.MaSinhVien, hocKy, loaiThi).then(
                (res) => {
        ...
        if (itemHocPhan) {
            ...
            ;(dataHocPhan.MC_KT_DangKyThi_TenCoSo = dataSV.CoSo
                ...
                (dataHocPhan.MC_KT_DangKyThi_MaSinhVien = dataSV.MaSinhVien
                    ? dataSV.MaSinhVien
                    : 'null')
            dataHocPhan.MC_KT_DangKyThi_HoDem = dataSV.HoDem
                ? dataSV.HoDem
                : 'null'
            ;(dataHocPhan.MC_KT_DangKyThi_Ten = dataSV.Ten
                ? dataSV.Ten
                : 'null'),
                (dataHocPhan.MC_KT_DangKyThi_GioiTinh =
                    dataSV.GioiTinh ?? 'null'),
            ...
            dataHocPhan.MC_KT_DangKyThi_TenMonHoc = itemHocPhan.TenMonHoc
                ...
                : 'null'
            dataHocPhan.MC_KT_DangKyThi_TenHinhThucThi =
