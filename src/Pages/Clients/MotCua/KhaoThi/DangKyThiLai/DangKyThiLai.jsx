...
import { getAllHocPhanDKThiLai, getKiemTraTrung, getTenDotDKThiLai, postDangKyThiLai } from '@/Apis/MotCua/KhaoThi/apiDangKyThiLai';
...
function DangKyThiLai() {
	...
	const handleSubmitData = async () => {
		...
		if (itemHocPhan) {
			...
			dataHocPhan.MC_KT_DangKyThi_TenCoSo= dataSV.CoSo ? dataSV.CoSo : "null",
			dataHocPhan.MC_KT_DangKyThi_MaSinhVien= dataSV.MaSinhVien ? dataSV.MaSinhVien : "null"
			...
			dataHocPhan.MC_KT_DangKyThi_TenHeDaoTao= dataSV.BacDaoTao ? dataSV.BacDaoTao : "null"
			dataHocPhan.MC_KT_DangKyThi_TenLoaiHinhDT= dataSV.LoaiHinhDaoTao ? dataSV.LoaiHinhDaoTao : "null"
			dataHocPhan.MC_KT_DangKyThi_TenKhoaHoc= dataSV.KhoaHoc ? dataSV.KhoaHoc : "null"
			dataHocPhan.MC_KT_DangKyThi_TenNganh= dataSV.ChuyenNganh ? dataSV.ChuyenNganh : "null"
