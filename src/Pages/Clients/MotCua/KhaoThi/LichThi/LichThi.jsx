...
function LichThi() {
    ...
    const handleSubmitData = async (event, files) => {
        ...
        if (itemHocPhan) {
            // Data post API
            dataHocPhan.MC_KT_LichThi_TenCoSo = dataSV.CoSo
                ? dataSV.CoSo
                : 'null'
            ...
            dataHocPhan.MC_KT_LichThi_MaSinhVien = dataSV.MaSinhVien
                ? dataSV.MaSinhVien
                : 'null'
            dataHocPhan.MC_KT_LichThi_HoDem = dataSV.HoDem
                ? dataSV.HoDem
                : 'null'
            ...
            dataHocPhan.MC_KT_LichThi_TenNghe = dataSV.ChuyenNganh
                ? dataSV.ChuyenNganh
                : 'null'
            dataHocPhan.MC_KT_LichThi_TenLop = dataSV.LopHoc
                ? dataSV.LopHoc
                : 'null'
            ...
            dataHocPhan.MC_KT_LichThi_TenMonHoc = itemHocPhan.TenMonHoc
                ...
                : 'null'
            dataHocPhan.MC_KT_LichThi_KhoaChuQuanMon =
                itemHocPhan.KhoaChuQuanMon ? itemHocPhan.KhoaChuQuanMon : 'null'
            dataHocPhan.MC_KT_LichThi_TenHinhThucThi =
