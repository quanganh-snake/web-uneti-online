...
function KetQuaHocTap() {
    ...
    const handleSubmitData = async (e) => {
        ...
        let dataHocPhan = {}
        if (itemHocPhan) {
            dataHocPhan.MC_KT_KetQuaHT_YeuCau = listLyDo
                .indexOf(lyDo)
                .toString()
            ...
            dataHocPhan.MC_KT_KetQuaHT_YeuCau_DiemThuongKy_SVYeuCau =
                lyDo === 'Điều chỉnh, bổ sung: Điểm thường kỳ'
                    ? diemSua.toString()
                    : 'null'
            dataHocPhan.MC_KT_KetQuaHT_TenCoSo = dataSV.CoSo
                ? dataSV.CoSo
                : 'null'
            ...
            dataHocPhan.MC_KT_KetQuaHT_MaSinhVien = dataSV.MaSinhVien
                ? dataSV.MaSinhVien
                : 'null'
            dataHocPhan.MC_KT_KetQuaHT_HoDem = dataSV.HoDem
                ? dataSV.HoDem
                : 'null'
            ...
            dataHocPhan.MC_KT_KetQuaHT_MaMonHoc = itemHocPhan.MaMonHoc
                ...
                : 'null'
            dataHocPhan.MC_KT_KetQuaHT_KhoaChuQuanMon =
