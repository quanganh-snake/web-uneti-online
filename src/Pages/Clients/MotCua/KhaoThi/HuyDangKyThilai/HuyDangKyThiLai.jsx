...
function HuyDangKyThiLai() {
    ...
    const handleSubmitData = async () => {
        ...
        if (itemHocPhan) {
            // dataSV
            dataHocPhan.MC_KT_HDKThiLai_TenCoSo = dataSV.CoSo
                ? dataSV.CoSo
                : 'null'
            ...
            dataHocPhan.MC_KT_HDKThiLai_MaSinhVien = dataSV.MaSinhVien
                ? dataSV.MaSinhVien
                : 'null'
            dataHocPhan.MC_KT_HDKThiLai_HoDem = dataSV.HoDem
                ? dataSV.HoDem
                : 'null'
            ...
            dataHocPhan.MC_KT_HDKThiLai_TenHinhThucThi =
                itemHocPhan.TenHinhThucThi ? itemHocPhan.TenHinhThucThi : 'null'
            ...
            dataHocPhan.MC_KT_HDKThiLai_TenMonHoc = itemHocPhan.TenMonHoc
                ...
                : 'null'
            dataHocPhan.MC_KT_HDKThiLai_DiemThuongKy1 =
                itemHocPhan.DiemTBThuongKy
            ...
            dataHocPhan.MC_KT_HDKThiLai_IsDat =
                itemHocPhan.IsDat !== null
                    ? itemHocPhan.IsDat.toString()
                    : 'null'
            dataHocPhan.MC_KT_HDKThiLai_KhoaChuQuanMon =
                itemHocPhan.KhoaChuQuanMon ? itemHocPhan.KhoaChuQuanMon : 'null'
            dataHocPhan.MC_KT_HDKThiLai_YeuCau_LyDoKhac_LyDoChiTiet =
