...
function PhucKhao() {
    ...
    const handleSubmitData = async (e) => {
        ...
        if (itemHocPhan) {
            // Data post API
            dataHocPhan.MC_KT_PhucKhao_TenCoSo = dataSV.CoSo
                ? dataSV.CoSo
                : 'null'
            ...
            dataHocPhan.MC_KT_PhucKhao_MaSinhVien = dataSV.MaSinhVien
                ? dataSV.MaSinhVien
                : 'null'
            dataHocPhan.MC_KT_PhucKhao_HoDem = dataSV.HoDem
                ? dataSV.HoDem
                : 'null'
            ...
            dataHocPhan.MC_KT_PhucKhao_TenNghe = dataSV.ChuyenNganh
                ? dataSV.ChuyenNganh
                : 'null'
            dataHocPhan.MC_KT_PhucKhao_TenLop = dataSV.LopHoc
                ? dataSV.LopHoc
                : 'null'
            ...
            dataHocPhan.MC_KT_PhucKhao_TenMonHoc = itemHocPhan.TenMonHoc
                ...
                : 'null'
            dataHocPhan.MC_KT_PhucKhao_KhoaChuQuanMon =
                itemHocPhan.KhoaChuQuanMon ? itemHocPhan.KhoaChuQuanMon : 'null'
            dataHocPhan.MC_KT_PhucKhao_TenHinhThucThi =
    ...
    useEffect(() => {
        ...
        if (tenDot !== '' && loaiThi !== '') {
            setLoading(true)
            getAllHocPhanPhucKhao(dataSV.MaSinhVien, tenDot, loaiThi).then(
                (res) => {
                    setLoading(false)
