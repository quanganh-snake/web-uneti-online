                    ...
                    <form className="lg:px-36" onSubmit={handleSubmitData}>
                                    ...
                                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        <thead className="text-xs text-white uppercase bg-sky-800 dark:bg-gray-700 dark:text-gray-400">
                                            <tr className="text-center">
                                                ...
                                                <th
                                                    scope="col"
                                                    className="px-6 py-3 border border-r"
                                                >
                                                    Nhóm
                                                </th>
                                                <th
                                                ...
                                                >
                                                    <p className="border-b w-full py-3">
                                                        Điểm
                                                    </p>
                                                    <table>
                                                        <tbody>
                        ...
                        <div className="uneti-notify my-4">
                            <p className="w-full font-bold text-red-600">
                                *Lưu ý: Lệ phí phúc khảo kết quả học tập: Có mức
                                thu theo quy định, được chuyển trực tiếp vào
                                công nợ của SV.
                            </p>
