...
function EmailLMS() {
    ...
    const handleSubmitData = async (e) => {
        ...
        dataYeuCau.MC_DT_EMAILLMS_TenNganh = dataSV.ChuyenNganh
            ? dataSV.ChuyenNganh
            : 'null'
        dataYeuCau.MC_DT_EMAILLMS_TenLop = dataSV.LopHoc
            ? dataSV.LopHoc
            : 'null'
        ...
        Swal.fire({
            title: `Bạn có chắc chắn muốn gửi yêu cầu ${
                listChiTietDeNghi.filter((e) => e.value === chiTietDeNghi)[0]
                    .text
            }?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
                    `Đã hủy yêu cầu ${
                        listChiTietDeNghi.filter(
                            (e) => e.value === chiTietDeNghi,
                        )[0].text
                    }`,
                    '',
                    'info',
    ...
    const handlePostData = async (dataYeuCau) => {
        try {
            ...
            if (
                ...
                const checkTrungTaiKhoan =
                    await getKiemTraTrungTaiKhoanEmailLMS(
