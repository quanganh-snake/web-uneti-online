    ...
    <Row gutter={20}>
      <Col span={12} md={4}>
        <div className="rounded-lg shadow-sm overflow-hidden">
          <div className="h-[50px] text-white bg-uneti-primary flex items-center justify-between px-2 py-3">
      ...
      <Col span={12} md={8}>
        <div className="rounded-lg shadow-sm overflow-hidden">
          <div className="h-[50px] text-white bg-uneti-primary flex items-center justify-center px-2 py-3">
