            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        setLoading(true)
                        const resDelete =
                            await deleteTrangThaiTTHCGV(dataIDDelete)
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        setLoading(true)
                        const resDelete =
                            await delTrinhTuThucHienTTHCGV(dataIDDelete)
                        if (resDelete.status === 200) {
                            setLoading(false)
                            return toast.success(
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        if (resDelete.status === 200) {
                            setLoading(false)
                            return toast.success(
                                `Xóa thành công mẫu giấy tờ kèm theo!`,
                            )
                        }
                    } catch (error) {
                        console.log(error.message)
            ...
            if (type === 'checkbox') {
                ...
                if (files && files.length > 0) {
                    if (tab === TABS.tabTPHSDeNghi) {
                        ...
                        convertDataFileToBase64(files[0]).then(
                            (dataFileBase64) => {
                                setEditValueRow((prevEditValueRow) => ({
                                    ...prevEditValueRow,
                                    MC_TTHC_GV_ThanhPhanHoSo_DataFile:
                                        dataFileBase64.split(',')[1],
                                }))
                            },
                        )
                    }
    ...
    const handleUpdate = async (type, valueRow) => {
        if (type === TABS.tabThongTinHoSo) {
            const newDataUpdateThongTinHoSo = {
                ...
                MC_TTHC_GV_NoiTiepNhan:
                    editThongTinChung?.MC_TTHC_GV_NoiTiepNhan,
                MC_TTHC_GV_NoiTraKetQua:
                    editThongTinChung?.MC_TTHC_GV_NoiTraKetQua,
            }
            ...
            if (isEqualValue == true) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        try {
                            const resUpdateThongTinHoSo =
                                await putThongTinHoSoThuTuc(
                                    newDataUpdateThongTinHoSo,
                                )
        ...
        if (type === TABS.tabTrinhTuThucHien) {
            let dataTrinhTuUpdate = {
                MC_TTHC_GV_TrinhTuThucHien_ID:
                    valueRow?.MC_TTHC_GV_TrinhTuThucHien_ID,
                    ...
                    if (result.isConfirmed) {
                        try {
                            const resUpdateTrinhTuThucHien =
                                await putTrinhTuThucHienTTHCGV(
                                    dataTrinhTuUpdate,
                                )
        ...
        if (type === TABS.tabTrangThai) {
            let dataTrangThaiUpdate = {
                ...
                MC_TTHC_GV_TrangThai_IDTTHC:
                    valueRow?.MC_TTHC_GV_TrangThai_IDTTHC,
                                ...
                                >
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <input
                                            ...
                                            defaultValue={
                                                ThongTinHoSo?.MC_TTHC_GV_TenThuTuc
                                            }
                                        ...
                                        <div className="w-full">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <input
                                                    ...
                                                    className="px-3 py-1 w-full border border-slate-200 rounded-md focus:outline-none"
                                                    defaultValue={
                                                        ThongTinHoSo?.MC_TTHC_GV_MaThuTuc
                                                    }
                                        ...
                                        <div className="w-full">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <input
                                                    ...
                                                    className="px-3 py-1 w-full border border-slate-200 rounded-md focus:outline-none"
                                                    defaultValue={
                                                        ThongTinHoSo?.MC_TTHC_GV_LinhVuc
                                                    }
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <input
                                            ...
                                            defaultValue={
                                                ThongTinHoSo?.MC_TTHC_GV_DoiTuongThucHien
                                            }
                                            disabled={true}
                                        ...
                                        <div className="w-full">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <input
                                                    ...
                                                    className="px-3 py-1 w-full border border-slate-200 rounded-md focus:outline-slate-400"
                                                    defaultValue={
                                                        ThongTinHoSo?.MC_TTHC_GV_NoiTiepNhan
                                                    }
                                        ...
                                        <div className="w-full">
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <input
                                                    ...
                                                    className="px-3 py-1 w-full border border-slate-200 rounded-md focus:outline-slate-400"
                                                    defaultValue={
                                                        ThongTinHoSo?.MC_TTHC_GV_NoiTraKetQua
                                                    }
                                                ...
                                                {ThanhPhanHoSo.map(
                                                    (iThanhPhan, index) => (
                                                        <tr
                                                            className="border-b"
                                                            key={
                                                                iThanhPhan.MC_TTHC_GV_ThanhPhanHoSo_ID
                                                            }
                                                        >
                                                            {editType ===
                                                                TABS.tabTPHSDeNghi &&
                                                ...
                                                {PhanQuyen.map(
                                                    (iPhanQuyen, index) => (
                                                        <tr
                                                            className="border-b"
                                                            key={
                                                                iPhanQuyen.MC_TTHC_GV_PhanQuyen_ID
                                                            }
                                                        >
                                                            <td className="border-r border-l px-2 py-1 text-center">
                                                                {index + 1}
