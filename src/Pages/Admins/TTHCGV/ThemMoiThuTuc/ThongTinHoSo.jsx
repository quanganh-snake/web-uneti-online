				...
				<div className="col-span-4 lg:col-span-2">
					<label htmlFor="MC_TTHC_GV_LinhVuc">
						...
						<div className="col-span-4 md:col-span-2 relative">
							...
							>
								<span className={clsx(linhVuc && "text-gray-700 font-semibold")}>{linhVuc ? linhVuc : "Chọn lĩnh vực thủ tục"}</span>
								<BiChevronDown size={20} className={clsx(openSelectLinhVuc && "rotate-180")} />
							</div>
							<ul className={clsx("bg-white mt-2 border shadow-lg overflow-y-auto absolute right-0 left-0 top-full z-10", openSelectLinhVuc ? "max-h-60" : "hidden")}>
										...
										return (
											<li
												...
												className={clsx(
													...
													iLinhVuc?.MC_TTHC_GV_LinhVuc.toLowerCase().includes(searchLinhVuc) ? "block" : "hidden"
												)}
												onClick={() => {
