...
const TrangThaiHoSo = memo(function TrangThaiHoSo(props) {
	const { trangThai, setTrangThai, handleAddTrangThai, setPhanQuyenActive, setTrangThaiActive, editRowIndex, setEditRowIndex } = props;
					...
					<tbody>
						{trangThai.length === 0 && (
							<tr className="text-center">
								<td colSpan={7}>
									<p className="px-2 py-2 font-semibold text-red-500">Chưa có trạng thái nào được thiết lập</p>
								</td>
							</tr>
						)}
