...
function PhiLePhi(props) {
	...
	return (
		<div className="uneti-tthcgv__tphosodenghi mb-5 w-full">
					...
					<tbody>
						{phiLePhi.length === 0 && (
							<tr className="text-center">
								<td colSpan={7}>
									<p className="px-2 py-2 font-semibold text-red-500">Chưa có mức phí nào được thiết lập</p>
								</td>
							</tr>
						)}
			...
			<button type="button" className="flex flex-row gap-2 items-center font-semibold text-xl text-white bg-[#245D7C] px-2 py-1 rounded-md hover:opacity-70" onClick={handleAddLePhi}>
