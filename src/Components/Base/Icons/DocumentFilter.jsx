  ...
  return (
    ...
    >
      <path
        ...
        className="document-filter-svg-elem-1"
      ></path>
      <path
        d="M22.0002 9C22.0002 5.88 21.2202 3.91999 19.4102 2.89999C18.9002 2.60999 17.8802 2.38999 16.9502 2.23999"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
        className="document-filter-svg-elem-2"
      ></path>
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="document-filter-svg-elem-3"
      ></path>
      <path
        d="M13 13H18"
        stroke="currentColor"
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="document-filter-svg-elem-4"
      ></path>
      <path
        d="M11 17H18"
        stroke="currentColor"
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="document-filter-svg-elem-5"
      ></path>
    </svg>
  )
}
