                ...
                <div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-4 mb-4">
                            <li>
                                - Bước 1: Thực hiện theo phương án khắc phục nếu
                                có. Trường hợp ô phương án khắc phục trống hoặc
                                đã thực hiện theo nhưng không thành công thì
                                thực hiện sang bước 2. Ảnh
                            </li>

                            <li>
                                - Bước 2: Tích chọn vào ô tròn trước lớp học
                                chứa thiết bị muốn báo hỏng.
                            </li>

                            <li>
                                - Bước 3: Tích chọn vào các ô vuông trước các sự
                                cố trong danh sách sự cố.
                            </li>

                            <li>
                                - Bước 4: Ấn nút &quot;Báo hỏng&quot; để hoàn
                                tất báo hòng thiết bị.
                            </li>
                        </ul>
                        <div>
                            <p className="text-vs-danger italic font-semibold">
                                Lưu ý quan trọng: Sau khi hiện thông báo báo
                                hỏng thành công, thông tin cán bộ kỹ thuật trực
                                thời gian đó sẽ được hiển thị. Giảng viên có thể
                                liên hệ theo số điện thoại nếu cần.
                            </p>
                        </div>
                    </div>
                </div>
