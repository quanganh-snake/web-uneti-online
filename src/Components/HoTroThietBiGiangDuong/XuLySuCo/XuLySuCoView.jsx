...
function XuLySuCoView() {
    ...
    const handleSubmitData = () => {
        ...
        dataSuLySuCo.DT_CVNB_TBGD_SuCo_MaNhanSu = dataCBGV.MaNhanSu
            ...
            : 'null'
        dataSuLySuCo.DT_CVNB_TBGD_SuCo_HoTen =
                                    ...
                                    {listLichDay.length ? (
                                        listLichDay.map((ld, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="p-2 border border-solid border-[#dee2e6]">
                                                    {ld.DT_CVNB_TBGD_SuCo_DanhSachSuCo.split(
                                                        ';',
                                                    ).map((e, index) => {
                                                        if (e.length) {
                                                            return (
                                        ...
                                        <tr>
                                            ...
                                            >
                                                Hiện tại chưa có dữ liệu để hiển
                                                thị
                                            </td>
                                        </tr>
                                    )}
                        ...
                        <div className="flex flex-col justify-start items-start gap-4">
                            <p>
                                ...
                                <span className="ml-2">
                                    {selectedRow.DT_CVNB_TBGD_SuCo_DanhSachSuCo &&
                                        selectedRow.DT_CVNB_TBGD_SuCo_DanhSachSuCo.split(
                                            ';',
                                        ).map((e, index) => {
                                            if (e.length) {
                                                return (
                            ...
                            <div className="w-full flex flex-col md:flex-row justify-between md:items-center gap-2">
                                ...
                                <Autocomplete
                                    ...
                                    size="small"
                                    multiple
                                    options={listNguyenNhan.map(
                                        (nn) => nn.DT_CVNB_TBGD_TL_Ten,
                                    )}
                                    value={nguyenNhan}
                            ...
                            <div className="w-full flex flex-col md:flex-row justify-between md:items-center gap-2">
                                ...
                                <Autocomplete
                                    ...
                                    size="small"
                                    multiple
                                    options={listKhacPhuc.map(
                                        (kp) => kp.DT_CVNB_TBGD_TL_Ten,
                                    )}
                                    value={khacPhuc}
                                    onChange={(event, newValue) => {
