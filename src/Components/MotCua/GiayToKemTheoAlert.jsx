    ...
    const handleDownloadFile = async (downloadId) => {
        try {
            ...
            switch (data.VBM_DataFileUpload.type) {
                case 'Buffer': {
                    handleFileFromArrayBuffer(
                        data.VBM_DataFileUpload.data,
                        filename,
                    )
                    break
                }
    ...
    return (
        ...
        TUYẾN, NGƯỜI HỌC CẦN ĐẾN BỘ PHẬN MỘT CỬA ĐỂ ĐỀ NGHỊ TRỰC TIẾP."
                content={
                    <>
                        <p>
                            Các giấy tờ kèm theo (click vào tên giấy tờ để tải
                            file):
                        </p>
                        <p>
                            ...
                            (Người học cần in, điền thông tin vào mẫu và nộp tại
                            bộ phận Một cửa hoặc đến trực tiếp bộ phận Một cửa
                            để lấy mẫu đề nghị giải quyết thủ tục hành chính).
                        </p>
                        <p>
                            2. Mẫu giấy tờ kèm theo đề nghị (nếu trong đề nghị
                            yêu cầu), người học tải file mẫu tại địa chỉ sau{' '}
                            <a
