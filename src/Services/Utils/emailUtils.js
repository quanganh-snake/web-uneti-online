...
export const sendEmailTTHCGiangVien = async (action='',dataUserSuggest = {}, dataUserHandle = {}, listThanhPhanHoSo = [], contentReply = "") => {
	if (contentReply == "") {
	...
	let emailHtml = `
        ...
        <div>
            ...
            <p>1.1. Mã nhân sự: <b>${dataUserSuggest?.MC_TTHC_GV_GuiYeuCau_NhanSuGui_MaNhanSu}</b></p>
            <p>1.2. Họ và tên: <b>${dataUserSuggest?.HoTen}</b></p>
            <p>1.3. Đơn vị quản lý nhân sự: <b>${dataUserSuggest?.MC_TTHC_GV_GuiYeuCau_NhanSuGui_Khoa}</b></p>
        </div>
        <div>
            ...
            <p>2.2. Nội dung yêu cầu: ${dataUserSuggest?.MC_TTHC_GV_GuiYeuCau_YeuCau_GhiChu}</p>
            <p>2.3. Số lượng bản in: ${dataUserSuggest?.MC_TTHC_GV_GuiYeuCau_KetQua_SoLuong}</p>
        </div>
        <div>
        ...
        <div>
            ...
            <p>&emsp;+ Họ và tên: ${dataUserHandle?.HoDem + " " + dataUserHandle?.Ten}</p>
